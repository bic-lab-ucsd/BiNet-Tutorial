...
```
    ...
    The downloaded binary packages are in
        C:\Users\Zoey\AppData\Local\Temp\RtmpaOBX0N\downloaded_packages
    ── R CMD build ─────────────────────────────────────────────────────────────────

    * checking for file 'C:\Users\Zoey\AppData\Local\Temp\RtmpaOBX0N\remotes57f4f03778f\bic-lab-ucsd-BiNet-Tutorial-64779d6\BiNet_Structural_Measures\betweenness_package/DESCRIPTION' ... OK
...
```
    ...
    9 fe801e88-5207-4550-a877-b072e25bebf4             56.00000            56
      language_betweenness_normalized   ego_id
    1                             NaN sofrom06
    2                       0.4142857 josmar03
    3                             NaN marsan05
    4                             NaN annbea01
    5                       0.5300000 luiher04
    6                       0.5522222 isaben08
    7                       1.0000000 tomgar09
    8                       0.4467593 davlop07
    9                       1.0000000 carrod02
...
<td><p>Total number of alter pairs from different language communities
considered in the computation</p>
<p><code>n_valid_pairs</code> can be used as a normalization factor when
ego networks differ in size or in the number of cross-language alter
pairs, ensuring that betweenness reflects the proportion of bridging
opportunities realized rather than the absolute number of
connections.</p></td>
</tr>
<tr>
<td><code>language_betweenness_normalized</code></td>
<td><p>Ego language betweenness normalized by the number of
cross-language alter pairs, computed as
<code>ego_language_betweenness</code> / <code>n_valid_pairs</code>.</p>
<p>This rescales the raw score into the proportion of cross-language
bridging opportunities actually realized by the ego, allowing comparison
across networks of different sizes or compositions.</p>
<p>NaN indicates that the ego’s network contains no alter pairs from
different language communities (e.g., a fully monolingual network),
making normalization undefined.</p></td>
</tr>
</tbody>
</table>
...
We compute the Density E–I index:
...
```
    ...
    # A tibble: 9 × 3
      networkCanvasEgoUUID                 ei_index_density ego_id  
      <chr>                                           <dbl> <chr>   
    1 4bc7e51b-a8af-4881-982e-12cfb2b1e9e3         NaN      annbea01
    2 fe801e88-5207-4550-a877-b072e25bebf4          -1      carrod02
    3 f68dccfc-29d6-47ab-ab7e-93b5ace9c226          -0.336  davlop07
    4 96f49992-a293-45b1-bd84-ccedf42d66fc          -0.0526 isaben08
    5 22e0f2c8-ddde-4271-bb6b-e9ec7fa6da6b          -0.410  josmar03
    6 82d2ef44-8636-4214-ba7b-4694793321d2          -0.264  luiher04
    7 28202870-0e8a-4600-9434-c280eff762cd         NaN      marsan05
    8 06029b97-694c-41b8-807e-4cb07dca16a8         NaN      sofrom06
    9 aff41946-2537-401a-a542-d53d6c177529          -1      tomgar09
