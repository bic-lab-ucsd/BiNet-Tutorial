...
- Higher values indicate that the ego is a central connector across
  ...
  [**Try the interactive
  example**](https://jil472-hue.github.io/egoLangBetweennessTEST/ego_betweenness_interactive_example.html) —
...
devtools::install_github("jil472-hue/egoLangBetweennessTEST", force = TRUE)
```
    ...
    The downloaded binary packages are in
        C:\Users\Zoey\AppData\Local\Temp\RtmpAvwYsD\downloaded_packages
    ── R CMD build ─────────────────────────────────────────────────────────────────

    * checking for file 'C:\Users\Zoey\AppData\Local\Temp\RtmpAvwYsD\remotesc2b82caea11\jil472-hue-egoLangBetweennessTEST-bbb87f2/DESCRIPTION' ... OK
